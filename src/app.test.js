...
describe('App', () => {
  ...
  let userCreate = { email: 'test2567@gmail.com', password: 'testestest' };
  ...
  const list2Search = '6352e5921a5569ed778ff123'; // place the id of the list
  ...
  const list2delete = '6352e7460ad12d96c3f869de';
